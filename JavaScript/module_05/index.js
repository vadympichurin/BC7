...
// const getUsersByFriend = (arr, name1) => {
//   let friends = arr.filter(function (el) {
//       return el.friends.includes(name1)
//   });
...
const getUsersByFriend = (arr, name1) => arr.filter(el => el.friends.includes(name1)).map(elem => elem.name);
...
//     let array = allskills.reduce(function (acc, el) {
...
//     });
//     console.log(sorting);
//     return sorting.filter(function (el, index, arr) {
...
const getAllSkills = arr => arr
    ...
    .sort((a, b) => a > b ? 1 : -1)
    .filter((el, index, array) => el !== array[index+1]);
